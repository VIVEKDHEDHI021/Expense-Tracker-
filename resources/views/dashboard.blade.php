    ...
    <div class="flex flex-col md:flex-row justify-between items-center mb-10">
        ...
        <div class="flex flex-wrap gap-4 mt-6 md:mt-0 items-center justify-center">
            ...
            <a href="/workerdisplay" 
               class="flex items-center justify-center gap-2 w-40 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold py-3 rounded-xl shadow-lg hover:scale-105 transition-all duration-300 text-center">
                <span>👷</span> Workers
            </a>

            <a href="/transaction/add-income"
               class="flex items-center justify-center gap-2 w-40 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-semibold py-3 rounded-xl shadow-lg hover:scale-105 transition-all duration-300 text-center">
                <span>➕</span> Income
            </a>

            <a href="/transaction/add-expense"
               class="flex items-center justify-center gap-2 w-40 bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 text-white font-semibold py-3 rounded-xl shadow-lg hover:scale-105 transition-all duration-300 text-center">
                <span>➖</span> Expense
            </a>
            
            <a href="/profile"
               class="flex items-center justify-center gap-2 w-40 bg-gradient-to-r from-purple-600 to-fuchsia-600 hover:from-purple-700 hover:to-fuchsia-700 text-white font-semibold py-3 rounded-xl shadow-lg hover:scale-105 transition-all duration-300 text-center">
                <span>👤</span> Profile
            </a>
